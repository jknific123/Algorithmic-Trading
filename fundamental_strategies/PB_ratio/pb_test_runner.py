...
from fundamental_strategies.PB_ratio import create_PB_trading_signals_on_lines as fundamentalTradingSignals
...
def simulateTradingOnPortfolio(start, portfolio, trading_dates, index_col, stock_prices_db, trgovalna_strategija):
    ...
    print()
    print('Rezultati P/B strategije: ')
...
#                            index_col=index_column, stock_prices_db=stockPricesDB, trgovalna_strategija='P/B')
