...
from fundamental_strategies.PE_ratio.old_version.pe_ratio import pe_ratio_strategy
        ...
        if zacetnoObdobje == start:
            ...
            for x in starting_companies:
                ...
                if x == "GM":
                    ...
                    prazen["Close"] = 0
                    return_df = pe_ratio_strategy(start_date=zacetnoObdobje, end_date=koncnoObdobje, df=prazen, ticker=x, starting_index=0, status=0, odZacetkaAliNe=True,
                    ...
                    return_df = pe_ratio_strategy(start_date=zacetnoObdobje, end_date=koncnoObdobje, df=data, ticker=x, starting_index=0, status=0, odZacetkaAliNe=True,
                                                  fundamental_data=fundamental_data)
                    portfolio[x] = return_df
        ...
        # ce nismo na zacetku gremo cez removed in added in naredimo menjave ter trejdamo za naslednje obdobje
            ...
            for odstranjenTicker in dowTickers[zacetnoObdobje]["removed"]:
                ...
                if odstranjenTicker in starting_companies:  # odstranjenTicker je v trenutnem portfoliu -> ga zamenjamo z isto ležečim tickerjem iz added
                    ...
                    new_returns = pe_ratio_strategy(start_date=zacetnoObdobje, end_date=koncnoObdobje, df=new_df, ticker=nov_ticker, starting_index=starting_index, status=0,
            ...
            for ostaliTicker in ostali:
                ...
                new_ostaliTickerDataframe = pe_ratio_strategy(start_date=zacetnoObdobje, end_date=koncnoObdobje, df=concat_data, ticker=ostaliTicker, starting_index=starting_index,
