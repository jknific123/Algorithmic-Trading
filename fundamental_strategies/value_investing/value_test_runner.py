...
from fundamental_strategies.value_investing import create_Value_trading_signals_on_lines as fundamentalTradingSignals
...
def simulateTradingOnPortfolio(start, portfolio, trading_dates, index_col, stock_prices_db, trgovalna_strategija):
    ...
    print()
    print('Rezultati Value investing strategije: ')
...
#                            index_col=index_column, stock_prices_db=stockPricesDB, trgovalna_strategija='VALUE')
