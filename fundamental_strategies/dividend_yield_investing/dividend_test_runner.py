...
from fundamental_strategies.dividend_yield_investing import create_dividend_trading_signals_on_lines as fundamentalTradingSignals
...
def simulateTradingOnPortfolio(start, portfolio, trading_dates, index_col, stock_prices_db, trgovalna_strategija):
    ...
    print()
    print('Rezultati strategije dividendnega donosa: ')
...
#                            index_col=index_column, stock_prices_db=stockPricesDB, trgovalna_strategija='DIVIDEND')
