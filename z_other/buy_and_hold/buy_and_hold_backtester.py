...
from buy_and_hold_grafi import profit_graph
        ...
        if zacetnoObdobje == start:
            ...
            for x in starting_companies:
                ...
                if x == "GM":
                    ...
                    prazen["Close"] = 0
                    return_df = buy_and_hold(sma_period_short, sma_period_long, prazen, x, 0, 0, True, hold_obdobje, True)  # moremo rezat glede na datum na zacetku
                    ...
                    return_df = buy_and_hold(sma_period_short, sma_period_long, data, x, 0, 0, True, hold_obdobje, True)  # moremo rezat glede na datum na zacetku
                    portfolio[x] = return_df
        ...
        # ce nismo na zacetku gremo cez removed in added in naredimo menjave ter trejdamo za naslednje obdobje
            ...
            for odstranjenTicker in dowTickers[zacetnoObdobje]["removed"]:
                ...
                if odstranjenTicker in starting_companies:  # odstranjenTicker je v trenutnem portfoliu -> ga zamenjamo z isto ležečim tickerjem iz added
                    ...
                    new_returns = buy_and_hold(sma_period_short, sma_period_long, new_df, nov_ticker, starting_index, 0, True, hold_obdobje, False)
            ...
            for ostaliTicker in ostali:
                ...
                new_ostaliTickerDataframe = buy_and_hold(sma_period_short, sma_period_long, concat_data, f"new{ostaliTicker}", starting_index,
