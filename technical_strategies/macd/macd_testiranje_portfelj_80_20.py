...
def testirajNaPortfoliuUcnaMnozica(dowTickers, stock_prices_db, hold_cas):
    ...
    with open(f'D:\Faks\Algorithmic-Trading\/technical_strategies\macd\macd_rezultati_ucna_80_20\MACD_{hold_obdobje_string}.txt', 'w', encoding='UTF8') as f:
...
def testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers, testnaStockPricesDB, hold_obdobja_list):
    ...
    optimalni_letni = [[18, 24, 9], [18, 40, 6], [20, 24, 9]]
    ...
    for hold_cas in hold_obdobja_list:
        ...
        for kombinacija in trenutni_parametri_list:
            ...
            temp = backtest('2018-09-09', '2021-11-21', kombinacija[0], kombinacija[1], kombinacija[2], dowTickers, testnaStockPricesDB, hold_cas)
        ...
        with open(f'D:\Faks\Algorithmic-Trading\/technical_strategies\macd\macd_rezultati_testna_80_20\MACD_{hold_obdobje_string}_testna.txt', 'w', encoding='UTF8') as f:
...
print('Testrianje sma strategy portelj, inicializacija objektov 80% - 20%')
