...
def testirajNaPortfoliuUcnaMnozica(dowTickers, stock_prices_db, hold_cas):
    ...
    with open(f'D:\Faks\Algorithmic-Trading\/technical_strategies\/bollinger_bands\/BB_rezultati_ucna_80_20\/bollinger_bands_{hold_obdobje_string}.txt', 'w', encoding='UTF8') as f:
...
def testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers, testnaStockPricesDB, hold_obdobja_list):
    optimalni_dnevni = [[30, 2], [50, 2.1], [40, 2.1]]
    optimalni_tedenski = [[30, 2], [50, 2.1], [40, 2.1]]
    optimalni_mesecni = [[30, 2], [50, 2.1], [40, 2.1]]
    optimalni_letni = [[40, 2.1], [20, 2], [30, 2]]
    ...
    for hold_cas in hold_obdobja_list:
        ...
        for kombinacija in trenutni_parametri_list:
            ...
            temp = backtest('2018-09-09', '2021-11-21', kombinacija[0], kombinacija[1], dowTickers, testnaStockPricesDB, hold_cas)
        ...
        with open(f'D:\Faks\Algorithmic-Trading\/technical_strategies\/bollinger_bands\/BB_rezultati_testna_80_20\/bollinger_bands_{hold_obdobje_string}_testna.txt', 'w',
                  encoding='UTF8') as f:
...
print('BB strategy portfelj, inicializacije objekta 80% - 20%')
