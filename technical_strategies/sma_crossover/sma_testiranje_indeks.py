...
def testirajOptimalneNaTestniMnoziciZaHoldObdobjaIndeks(testnaStockPricesDB, hold_obdobja_list):
    ...
    indeks_data_testna = testnaStockPricesDB.getCompanyStockDataInRange(date_from="2017-02-02", date_to="2021-11-21", companyTicker='^DJI')
...
testirajNaIndeksuEnoKombinacijo(start_date="2005-11-21", end_date="2021-11-21", short_sma=70, long_sma=150,
