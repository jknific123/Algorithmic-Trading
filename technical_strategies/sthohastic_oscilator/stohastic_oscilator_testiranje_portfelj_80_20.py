...
def testirajNaPortfoliuUcnaMnozica(dowTickers, stock_prices_db, hold_cas):
    ...
    with open(f'D:\Faks\Algorithmic-Trading\/technical_strategies\/sthohastic_oscilator\/Stohastic_rezultati_ucna_80_20\/stohastic_oscilator_{hold_obdobje_string}.txt', 'w', encoding='UTF8') as f:
...
def testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers, testnaStockPricesDB, hold_obdobja_list):
    ...
    for hold_cas in hold_obdobja_list:
        ...
        with open(f'D:\Faks\Algorithmic-Trading\/technical_strategies\/sthohastic_oscilator\/Stohastic_rezultati_testna_80_20\/stohastic_oscilator_{hold_obdobje_string}_testna.txt', 'w', encoding='UTF8') as f:
