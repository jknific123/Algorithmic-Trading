        ...
        if zacetnoObdobje == start:
            ...
            for x in starting_companies:
                ...
                if x == "GM":
                    ...
                    prazen["Close"] = 0
                    return_df = stohastic_oscilator(high_low_period, d_sma_period, prazen, x, 0, 0, True, hold_obdobje, True)
                    ...
                    return_df = stohastic_oscilator(high_low_period, d_sma_period, data, x, 0, 0, True, hold_obdobje, True)
                    portfolio[x] = return_df
        ...
        # ce nismo na zacetku gremo cez removed in added in naredimo menjave ter trejdamo za naslednje obdobje
            ...
            for odstranjenTicker in dowTickers[zacetnoObdobje]["removed"]:
                ...
                if odstranjenTicker in starting_companies:  # odstranjenTicker je v trenutnem portfoliu -> ga zamenjamo z isto ležečim tickerjem iz added
                    ...
                    new_returns = stohastic_oscilator(high_low_period, d_sma_period, new_df, nov_ticker, starting_index, 0, True, hold_obdobje, False)
            ...
            for ostaliTicker in ostali:
                ...
                new_ostaliTickerDataframe = stohastic_oscilator(high_low_period, d_sma_period, concat_data, f"new{ostaliTicker}", starting_index, zadnji_signal, False, hold_obdobje, False)
