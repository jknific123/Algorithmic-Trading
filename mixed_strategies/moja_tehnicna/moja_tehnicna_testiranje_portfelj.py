    ...
    with open(f'D:\Faks\Algorithmic-Trading\/mixed_strategies\/moja_tehnicna\/moja_tehnicna_rezultati_ucna\/Moja_tehnicna_{hold_obdobje_string}.txt', 'w', encoding='UTF8') as f:
        for x in sorted_rez_total_ucni:
            ...
            row_string = str(x) + ': ' + str(round(sorted_rez_total_ucni[x], 2)) + ' ' + str(
                util.povprecnaLetnaObrestnaMera(
                    rez_zacetna_investicija_ucni[x], sorted_rez_total_ucni[x], util.ucnaMnozicaLeta())) + '% ' + str(round(rez_zacetna_investicija_ucni[x], 2))
...
def testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers, testnaStockPricesDB, hold_obdobja_list):
    optimalni_dnevni = [[[5, 3], [30, 2]],  [[15, 14], [50, 2.1]],  [[15, 14], [20, 2]]]
    optimalni_tedenski = [[[5, 3], [30, 2]],  [[15, 14], [50, 2.1]],  [[15, 14], [20, 2]]]
    optimalni_mesecni = [[[5, 3], [30, 2]],  [[15, 14], [50, 2.1]],  [[15, 14], [20, 2]]]
    optimalni_letni = [[[9, 8], [50, 2.1]],  [[15, 14], [50, 2.1]],  [[15, 11], [50, 2.1]]]
