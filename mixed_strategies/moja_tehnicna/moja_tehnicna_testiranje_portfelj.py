...
def testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers, testnaStockPricesDB, hold_obdobja_list):
    optimalni_dnevni = [[[15, 4], [10, 1.9]],  [[9, 8], [20, 2]],  [[5, 3], [10, 1.9]]]
    optimalni_tedenski = [[[15, 4], [10, 1.9]],  [[9, 8], [20, 2]],  [[5, 3], [10, 1.9]]]
    optimalni_mesecni = [[[15, 4], [10, 1.9]],  [[9, 8], [20, 2]],  [[5, 3], [10, 1.9]]]
    optimalni_letni = [[[9, 5], [30, 2]],  [[20, 3], [40, 2.1]],  [[9, 5], [20, 2]]]
