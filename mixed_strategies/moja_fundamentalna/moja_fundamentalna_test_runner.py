...
from mixed_strategies.moja_fundamentalna import create_MojaFundamentalna_trading_signals_on_lines as fundamentalTradingSignals
...
def simulateTradingOnPortfolio(start, portfolio, trading_dates, index_col, stock_prices_db, trgovalna_strategija):
    ...
    print()
    print('Rezultati Moja fundamentalna strategije: ')
...
#                            index_col=index_column, stock_prices_db=stockPricesDB, trgovalna_strategija='MF')
