...
from mixed_strategies.moja_mesana.moja_mesana_dividend.moja_mesana_dividend_yield_grafi import profit_graph
...
# Dividend yield investing strategy + SMA crossover
