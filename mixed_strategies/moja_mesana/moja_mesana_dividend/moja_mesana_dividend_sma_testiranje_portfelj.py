...
from mixed_strategies.moja_mesana.moja_mesana_dividend.moja_mesana_dividend_yield_backtester import zacetniDf, backtest
from mixed_strategies.moja_mesana.moja_mesana_dividend.moja_mesana_dividend_yield import dividend_investing_sma_crossover_strategy
...
from mixed_strategies.moja_mesana.moja_mesana_dividend.moja_mesana_dividend_yield_grafi import mojaFundamentalna_trading_graph, profit_graph
...
def testirajNaPortfoliuUcnaMnozica(dowTickers, stock_prices_db, fundamental_indicators_db_portfelj):
    ...
    with open(f'D:\Faks\Algorithmic-Trading\/mixed_strategies\moja_mesana\moja_mesana_dividend\mesana_dividend_SMA_ucna\Dividend_investing_SMA_crossover.txt', 'w', encoding='UTF8') as f:
...
def testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers, testnaStockPricesDB, fundamentalIndicatorsDBPortfelj):
    optimalni_parametri = [[85, 150], [85, 124], [100, 124]]

    rez_total_testni = {}
    zacetni_cas = datetime.datetime.now()
    for kombinacija in optimalni_parametri:
        print('Kombinacija: ', kombinacija)
        temp = backtest('2017-02-02', '2021-11-21', kombinacija[0], kombinacija[1], dowTickers, testnaStockPricesDB, fundamentalIndicatorsDBPortfelj)
    ...
    with open(f'D:\Faks\Algorithmic-Trading\/mixed_strategies\moja_mesana\moja_mesana_dividend\mesana_dividend_SMA_testna\Dividend_investing_SMA_crossover_testna.txt', 'w', encoding='UTF8') as f:
...
""" Testrianje High dividend yield investing + SMA crossover na portelju delnic iz indeksa """
...
# testirajOptimalneNaTestniMnoziciZaHoldObdobja(dowTickers=dowJonesIndexData, testnaStockPricesDB=stockPricesDB, fundamentalIndicatorsDBPortfelj=fundamentalIndicatorsDB)

# preverjanje uspesnosti optimalnih kombinacij na celotnem casovnem obdobju
testirajNaPortfoliuEnoKombinacijo(start_date="2005-11-21", end_date="2021-11-21", short_sma=100, long_sma=124,
