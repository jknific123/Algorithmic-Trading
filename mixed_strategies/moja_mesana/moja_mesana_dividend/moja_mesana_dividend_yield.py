...
def dividend_investing_sma_crossover_strategy(start_date, end_date, sPeriod, lPeriod, df, ticker, starting_index, status, odZacetkaAliNe, fundamental_data):
    ...
    for x in range(starting_index, len(df)):
        ...
        # TODO generiraj fundamentalni BUY/ SELL signal
